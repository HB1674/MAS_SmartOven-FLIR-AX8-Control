...
▶ [FLIR AX8 Control Program Demo](VIDEO_LINK_FLIR_CONTROL)
...
▶ [SmartOven System Operation Demo](VIDEO_LINK_SMARTOVEN)

▶ [SmartOven Actual Production Environment](VIDEO_LINK_PRODUCTION)
